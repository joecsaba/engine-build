...
export default function BoostCompressionCalculator() {
  ...
  // Volumetric DCR: (CR - 1) × (effStroke/stroke) + 1 — matches the dedicated
  // compression-ratio calculator. Avoids cylinder-pressure polytropic form.
  const dcr = s > 0 ? (scr - 1) * (effectiveStroke / s) + 1 : 0;
