...
/* ─── octane lookup table ───
   Cranking-PSI to recommended pump octane based on Pat Kelley's "Dynamic Compression Ratio"
   article (also cross-referenced with Vizard "How to Build Horsepower" Ch.5). Columns are head
   type (iron traditional, iron fast-burn, aluminum traditional, aluminum fast-burn) — aluminum
   and fast-burn chambers tolerate ~1 octane lower than equivalent iron/traditional chambers. */
