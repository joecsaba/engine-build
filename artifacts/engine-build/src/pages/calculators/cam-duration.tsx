...
function calc(s: State) {
  ...
  // Volumetric DCR: DCR = (V_eff + V_clear) / V_clear = (CR - 1) × (effStroke/stroke) + 1
  // Matches the dedicated compression-ratio calculator. (Some sources use the
  // polytropic form CR × ratio^1.3 — that's cylinder pressure ratio, not DCR.)
  const dynamicCR = stroke > 0 ? (cr - 1) * (effectiveStroke / stroke) + 1 : 0;
