...
const CALCS = [
  // ─── Short Block ────────────────────────────────────────────────────────
  { slug: "displacement",                  category: "short-block",     title: "Engine Displacement Calculator",                 description: "Calculate engine displacement in cubic inches, liters, and CC from bore, stroke, and cylinder count. Free, instant, no signup." },
  { slug: "compression-ratio",             category: "short-block",     title: "Compression Ratio Calculator",                   description: "Static and dynamic compression ratio with octane recommendations. Three IVC input methods, cranking pressure, reverse-solve mode." },
  ...
  // ─── Power & Fuel ──────────────────────────────────────────────────────
  { slug: "hp-torque",                     category: "power-fuel",      title: "HP and Torque Converter",                        description: "Bidirectional HP/Torque converter. Shows the formula, the 5252 crossover point, and unit conversions." },
  ...
  { slug: "wrench-size-converter",         category: "drivetrain-shop", title: "Wrench Size Converter — SAE to Metric",          description: "Convert SAE wrench sizes to metric and back. Closest match, exact gap in mm and thousandths, and whether the swap is safe under torque or will round the fastener." },
